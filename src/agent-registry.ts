...
export const AGENT_META: AgentMeta[] = [
  ...
  { name: 'Athena',        role: 'Principal Reviewer · senior PhD-level engineer · Claude Opus 4.8 (xhigh) PR gate · owns coding standards', avatar: '🦉', color: '#9333ea', kind: 'reviewer', models: ['claude-opus'], teams: ['cross', 'scrum-roblox', 'scrum-web', 'scrum-marketing'], tools: ['coordination.*', 'codegraph.*', 'scrum.bug', 'scrum.standup', 'governance.lineage', 'forum.*', 'wiki.lookup'] },
